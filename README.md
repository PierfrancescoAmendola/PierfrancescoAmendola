...
🎓 University Email: pi.amendola@studenti.unina.it
...
Explain global implications of cyber threats and network vulnerabilities
Describe the impact of cyber-attacks across industries
Understand Cisco’s approach to threat detection and defense
Recognize cybersecurity as a growing professional field and identify related career opportunities
...
https://www.freecodecamp.org/certification/pierfrancesco05/javascript-algorithms-and-data-structures-v8
...
Optimized shifting algorithms and memory management to achieve near-logarithmic performance on average.
...
Programming Languages: C, C++, Python, Java, Dart, Swift, JavaScript
Frameworks / Libraries: React Native, HTML, CSS
Other Skills: Bash scripting, mobile development, data analysis
Soft Skills: Teamwork, Problem Solving, Adaptability, Curiosity-driven learning, Communication, Loyal, Strong verbal communication skills, Persuasive, Influential

**Tools & Technologies:** Docker, Git, GitHub, VS Code, Xcode, Android Studio, Eclipse  
**Operating Systems:** Windows, macOS, Linux (Ubuntu, Kali Linux, Parrot)
...
International Chamber Music Workshop (October 31 – November 3, 2024): Participated in an international chamber music workshop led by Dora Cantella (Professor at CRD de Meudon, Paris) and Pierfrancesco Borrelli (Professor at the Conservatory of Avellino).

Piano and Guitar Instructor: Teaching piano and guitar to children, focusing on musical expression and foundational technique. Began studying piano at age 3 and later learned guitar and violin as a self-taught musician during a period spent in England.

Musical Composition and Direction: Composed instrumental bases and lyrics for original songs, directed an orchestra, and currently serve as Artistic Director for local music projects.

Author and Researcher: Co-author of the book Arcobaleni e Nuvole, published with the University of Naples Federico II. Currently writing a philosophical essay, a novel, and a collection of poems and songs (songbook).

Cultural Projects – “Adopt a Philosopher and a Scientist”: Participated in two editions of the national competition Adotta un filosofo e uno scienziato, presenting original cinematic projects. Ranked 5th in the first edition and 3rd in the second.

Merit Scholarship – Freie Universität Berlin (declined): Awarded a scholarship for advanced studies at Freie Universität Berlin, declined in order to complete the Computer Science degree in Italy.

**Amazon KDP self-publishing:** Wrote and self-published four children’s books, managing the entire creative process — writing, illustration design, layout, and publication.  

**Award Ceremony – 49th National Competition “Civis Sum”**: Participated in the national award ceremony recognizing civic engagement and cultural excellence.  

**Learning Walk in San Giovanni a Teduccio**: On-site exploration focused on local development, urban transformation, and community impact.  

**Jane’s Walk**: Participated in a community-led urban walk promoting active exploration of neighborhoods and citizen-focused urbanism.  

**PCTO in Urban Architecture**: Completed a training program involving urban planning, architectural analysis, and territorial development.
